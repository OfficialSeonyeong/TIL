...
import pandas as pd
data = pd.read_csv('./service_bmi.csv', encoding='utf-8')
print(data.info())
print(data.head())
print(data.tail())
...
def load_xls() :
    kospi = pd.ExcelFile('../documents/sam_kospi.xlsx')
...
def json_load_file() :
    with open('../documents/usagov_bitly.txt','r', encoding='utf-8') as file :
