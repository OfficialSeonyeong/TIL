...
class MyEngine(Engine):
    ...
    def train(engine, mini_batch):
        ...
        # That means this will be applied on only 'classification' task.
    ...
    def attach(train_engine, validation_engine, verbose=VERBOSE_BATCH_WISE):
        ...
        trainting_metric_names = ['loss', 'accuracy', '|param|', '|g_param|']

        for metric_name in trainting_metric_names:
        ...
        if verbose >= VERBOSE_BATCH_WISE:
            ...
            pbar.attach(train_engine, trainting_metric_names)
