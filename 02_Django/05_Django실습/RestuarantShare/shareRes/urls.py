...
urlpatterns = [
    ...
    path('restaurantDetail/<str:id>', views.restaurantDetail, name='resDetailPage'),
    path('restaurantDetail/updatePage/update', views.Update_restaurant, name='resUpdate'),
    path('restaurantDetail/updatePage/<str:id>', views.restaurantUpdate, name='resUpdatePage'),
